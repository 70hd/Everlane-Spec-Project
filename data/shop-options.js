    ...
    links: [
      {
        ...
        alt: "All Womens Clothing",
        text: "All Womens Clothing",
        link: "/shop/women",
      },
      {
        image:
    ...
    links: [
      {
        ...
        description:
          "Fresh styles just dropped. Discover the latest arrivals designed with modern simplicity and everyday ease in mind. Be the first to wear what’s next.",
      },
      {
        image:
        ...
        description:
          "Rare finds that won’t last long. Shop exclusive styles with limited stock—perfect for those who like to stand out with something truly special.",
      },
      {
        image:
        ...
        description:
          "Fan favorites and all-time hits. These are the pieces everyone’s loving—versatile, well-made, and constantly selling out. Don’t miss your chance.",
      },
      {
        image:
        ...
        description:
          "Style steals await. Grab timeless pieces at a rare discount—quality essentials you’ll wear on repeat, now at prices you’ll love even more.",
      },
      {
        image:
        ...
        description:
          "Only here, only for you. This handpicked collection features members-only drops and limited editions you won’t find anywhere else.",
      },
    ]
...
//   {
//     id: 5,
//     title: "The Eco-Friendly Shirt",
//     description: "A sustainable cotton shirt that's soft and comfortable.",
//     gender: "MEN",
//     price: 60,
//     inventory: 1000,
...
//     ],
//     size: ["S", "M", "L"],
//     productDetails: "Made with organic cotton, this shirt is designed for eco-conscious buyers.",
