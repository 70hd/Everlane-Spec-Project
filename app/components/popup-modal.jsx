        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/30">
          <div className="w-fit md:w-[702px] h-fit flex flex-col md:p-12 p-6 custom-gap-9 bg-white border border-black/25">
            ...
            <div className="w-full h-[125px] overflow-y-auto">
              <p>
  This is a speculative design project created for educational and portfolio purposes only.  
  <br /><br />
  This site is not affiliated with, endorsed by, or connected to Everlane or any of its partners. All trademarks, brand names, and product imagery are the property of their respective owners.  
  <br /><br />
  This project is intended solely to showcase design and development skills. No products are actually for sale, and no user data is collected.
              </p>
            </div>
             <button className="sm:w-fit w-full min-w-fit h-fit p-3 border border-black bg-black text-white hover:bg-black/75" onClick={closeSpecModal}>
